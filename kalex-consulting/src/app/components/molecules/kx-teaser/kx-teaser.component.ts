...
export class KxTeaserComponent implements OnInit {
    ...
    teasers = [
        ...
        {
            title: 'Unternehmen',
            text: 'Nearshoring ist die Verlagerung betrieblicher Aktivitäten ins nahegelegene Ausland. Nearshoring soll wie Offshoring die Personalkosten senken. Dabei ist der monetäre Vorteil durch Lohnunterschiede weniger hoch als beim Farshoring. Die größere kulturelle und räumliche Nähe bei nahezu gleicher Zeitzone vereinfacht jedoch dieKooperation massgebend.<br><br>Diese Form des Offshorings kann auch genutzt werden, um sich auf dem Markt des gewählten Landes zu positionieren und somit eine Win-win-Situation zu realisieren.<br><br><b>Warum Serbien?</b><br><br>- gleiche Zeitzone<br>- geografische Lage (1000km)<br>- Verfügbarkeit von qualifizierten Arbeitskräften mit ausgezeichneten Deutsch- und Englischkenntnissen<br>- täglich 6 Flüge nach Serbien (1.5h)<br>- bereits 500 Unternehmen aus der Schweiz, welche 11\'000 Mitarbeiter beschäftigen<br>- 2016 war die Schweiz zweitgrösster Investor in Serbien<br>- grosse Diaspora mit 300\'000 Serben in der Schweiz',
            isOpen: false
        }
    ];
